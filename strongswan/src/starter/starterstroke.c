...
static void starter_stroke_add_end(stroke_msg_t *msg, stroke_end_t *msg_end, starter_end_t *conn_end)
{
	...
	msg_end->imei_format = conn_end->imei_format;
}
...
int starter_stroke_add_conn(starter_config_t *cfg, starter_conn_t *conn)
{
	...
	msg.add_conn.redirect_enable = conn->redirect_enable;
	msg.add_conn.max_redirects = conn->max_redirects;
	msg.add_conn.redirect_loop_detect = conn->redirect_loop_detect;
	msg.add_conn.emergency_numbers = conn->emergency_numbers;
