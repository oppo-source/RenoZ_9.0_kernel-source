...
static const token_info_t token_info[] =
{
	...
	{ ARG_ENUM, offsetof(starter_conn_t, redirect_enable), LST_bool 			 },
	{ ARG_UINT, offsetof(starter_conn_t, max_redirects), NULL				  },
	{ ARG_UINT, offsetof(starter_conn_t, redirect_loop_detect), NULL				 },
	{ ARG_ENUM, offsetof(starter_conn_t, emergency_numbers), LST_bool               },
	...
	{ ARG_UINT, offsetof(starter_end_t, imei_format), NULL                         },
