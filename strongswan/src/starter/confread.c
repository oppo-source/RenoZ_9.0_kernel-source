...
/*this is handled in arcg.c*/
	...
	cfg->conn_default.redirect_enable = FALSE;
	cfg->conn_default.max_redirects = MAX_REDIRECTS;
	cfg->conn_default.redirect_loop_detect = REDIRECT_LOOP_DETECT_PERIOD;
	cfg->conn_default.emergency_numbers = FALSE;
