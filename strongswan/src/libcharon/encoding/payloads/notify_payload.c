...
ENUM_NEXT(notify_type_names, SINGLE_PAIR_REQUIRED, CHILD_SA_NOT_FOUND, AUTHENTICATION_FAILED,
	...
	"TEMPORARY_FAILURE",
	"CHILD_SA_NOT_FOUND");
ENUM_NEXT(notify_type_names, PDN_CONNECTION_REJECTION, MAX_CONNECTION_REACHED, CHILD_SA_NOT_FOUND,
	"PDN_CONNECTION_REJECTION",
	"MAX_CONNECTION_REACHED");
ENUM_NEXT(notify_type_names, NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED, AUTHORIZATION_REJECTED, MAX_CONNECTION_REACHED,
	"NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED",
	"USER_UNKNOWN",
	"NO_APN_SUBSCRIPTION",
	"AUTHORIZATION_REJECTED");
ENUM_NEXT(notify_type_names, ILLEGAL_ME, ILLEGAL_ME, AUTHORIZATION_REJECTED,
	"ILLEGAL_ME");
ENUM_NEXT(notify_type_names, NETWORK_FAILURE, NETWORK_FAILURE, ILLEGAL_ME,
	"NETWORK_FAILURE");
ENUM_NEXT(notify_type_names, RAT_TYPE_NOT_ALLOWED, RAT_TYPE_NOT_ALLOWED, NETWORK_FAILURE,
	"RAT_TYPE_NOT_ALLOWED");
ENUM_NEXT(notify_type_names, IMEI_NOT_ACCEPTED, IMEI_NOT_ACCEPTED, RAT_TYPE_NOT_ALLOWED,
	"IMEI_NOT_ACCEPTED");
ENUM_NEXT(notify_type_names, PLMN_NOT_ALLOWED, PLMN_NOT_ALLOWED, IMEI_NOT_ACCEPTED,
	"PLMN_NOT_ALLOWED");
ENUM_NEXT(notify_type_names, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED, PLMN_NOT_ALLOWED,
	"UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED");
ENUM_NEXT(notify_type_names, MS_NOTIFY_STATUS, MS_NOTIFY_STATUS, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED,
	"MS_NOTIFY_STATUS");
...
ENUM_NEXT(notify_type_names, DEVICE_IDENTITY, DEVICE_IDENTITY, BACKOFF_TIMER,
	"DEVICE_IDENTITY");
ENUM_NEXT(notify_type_names, EMERGENCY_SUPPORT, EMERGENCY_SUPPORT, DEVICE_IDENTITY,
	"EMERGENCY_SUPPORT");
ENUM_NEXT(notify_type_names, EMERGENCY_CALL_NUMBERS, EMERGENCY_CALL_NUMBERS, EMERGENCY_SUPPORT,
	"EMERGENCY_CALL_NUMBERS");
ENUM_NEXT(notify_type_names, NBIFOM_GENERIC_CONTAINER, NBIFOM_GENERIC_CONTAINER, EMERGENCY_CALL_NUMBERS,
	"NBIFOM_GENERIC_CONTAINER");
ENUM_NEXT(notify_type_names, PCSCF_RESELECTION_SUPPORT, PCSCF_RESELECTION_SUPPORT, NBIFOM_GENERIC_CONTAINER,
	"PCSCF_RECELECT_SUPPORRT");
ENUM_NEXT(notify_type_names, PTI, PTI, PCSCF_RESELECTION_SUPPORT,
	"PTI");
ENUM_END(notify_type_names, PTI);
...
ENUM_NEXT(notify_type_short_names, SINGLE_PAIR_REQUIRED, CHILD_SA_NOT_FOUND, AUTHENTICATION_FAILED,
	...
	"TEMP_FAIL",
	"NO_CHILD_SA");
ENUM_NEXT(notify_type_short_names, PDN_CONNECTION_REJECTION, MAX_CONNECTION_REACHED, CHILD_SA_NOT_FOUND,
	"PDN_CONN_REJ",
	"MAX_CONN_RCHD");
ENUM_NEXT(notify_type_short_names, NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED, AUTHORIZATION_REJECTED, MAX_CONNECTION_REACHED,
	"N3GPP_2EPC_N_ALWD",
	"USER_UNKNOWN",
	"NO_APN_SUBSCRPT",
	"AUTH_REJECTED");
ENUM_NEXT(notify_type_short_names, ILLEGAL_ME, ILLEGAL_ME, AUTHORIZATION_REJECTED,
	"ILLEGAL_ME");
ENUM_NEXT(notify_type_short_names, NETWORK_FAILURE, NETWORK_FAILURE, ILLEGAL_ME,
	"NW_FAILURE");
ENUM_NEXT(notify_type_short_names, RAT_TYPE_NOT_ALLOWED, RAT_TYPE_NOT_ALLOWED, NETWORK_FAILURE,
	"RAT_NOT_ALWD");
ENUM_NEXT(notify_type_short_names, IMEI_NOT_ACCEPTED, IMEI_NOT_ACCEPTED, RAT_TYPE_NOT_ALLOWED,
	"IMEI_NOT_ACPT");
ENUM_NEXT(notify_type_short_names, PLMN_NOT_ALLOWED, PLMN_NOT_ALLOWED, IMEI_NOT_ACCEPTED,
	"PLMN_NOT_ALWD");
ENUM_NEXT(notify_type_short_names, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED, PLMN_NOT_ALLOWED,
	"UNAUTH_EMRG_N_SUP");
ENUM_NEXT(notify_type_short_names, MS_NOTIFY_STATUS, MS_NOTIFY_STATUS, UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED,
	"MS_STATUS");
...
ENUM_NEXT(notify_type_short_names, DEVICE_IDENTITY, DEVICE_IDENTITY, BACKOFF_TIMER,
	"DEVICE_IDENTITY");
ENUM_NEXT(notify_type_short_names, EMERGENCY_SUPPORT, EMERGENCY_SUPPORT, DEVICE_IDENTITY,
	"EMERG_SUPPORT");
ENUM_NEXT(notify_type_short_names, EMERGENCY_CALL_NUMBERS, EMERGENCY_CALL_NUMBERS, EMERGENCY_SUPPORT,
	"EMERG_CALL_NUM");
ENUM_NEXT(notify_type_short_names, NBIFOM_GENERIC_CONTAINER, NBIFOM_GENERIC_CONTAINER, EMERGENCY_CALL_NUMBERS,
	"NBIFOM_GEN_CONT");
ENUM_NEXT(notify_type_short_names, PCSCF_RESELECTION_SUPPORT, PCSCF_RESELECTION_SUPPORT, NBIFOM_GENERIC_CONTAINER,
	"PCSCF_RECELECT_S");
ENUM_NEXT(notify_type_short_names, PTI, PTI, PCSCF_RESELECTION_SUPPORT,
	"PTI");
ENUM_END(notify_type_short_names, PTI);
	...
	private_notify_payload_t *this)
{
	...
	switch (this->notify_type)
	{
		...
		{
			if (this->type == NOTIFY &&
				this->notify_data.len != 0 &&
				this->notify_data.len != 2)
			{
				bad_length = TRUE;
			}
			break;
