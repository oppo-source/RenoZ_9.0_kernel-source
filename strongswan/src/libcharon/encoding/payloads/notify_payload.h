...
enum notify_type_t {
	...
	/* The Private Notify Message error code: TS 24.302 -e50.doc 8.1.2.2*/
	...
	/* The Private Notify Message status code: TS 24.302-e50.doc 8.1.2.3*/
	EMERGENCY_SUPPORT = 41112,
	EMERGENCY_CALL_NUMBERS = 41134,
	NBIFOM_GENERIC_CONTAINER = 41288,
	/* P-CSCF_RESELECTION_SUPPORT indication,3gppts 24.302-d80*/
	PCSCF_RESELECTION_SUPPORT = 41304,
	/* The Private Notify Message status code: TS 24.302-e50.doc 8.1.2.3*/
	PTI = 41501
};
...
extern bool is_error_notify(notify_payload_t*);

extern bool is_status_notify(notify_payload_t*);
