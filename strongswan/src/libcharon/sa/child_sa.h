...
struct child_sa_t {
	...
	/**
	 * Set tsi for this CHILD_SA rekey.
	 *
	 * @param tsi list
	 */
	void (*set_rekey_tsi)(child_sa_t *this, linked_list_t * tsi_rekey);

	/**
	 * Set tsr for this CHILD_SA rekey.
	 *
	 * @param tsr list
	 */
	void (*set_rekey_tsr)(child_sa_t *this, linked_list_t * tsr_rekey);

	/**
	 * get tsi for this CHILD_SA rekey.
	 *
	 * @Return tsi list
	 */
	linked_list_t * (*get_rekey_tsi)(child_sa_t *this);

	/**
	 * get tsr for this CHILD_SA rekey.
	 *
	 * @Return tsr list
	 */
	linked_list_t * (*get_rekey_tsr)(child_sa_t *this);
