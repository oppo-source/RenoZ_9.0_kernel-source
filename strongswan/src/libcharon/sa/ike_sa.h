...
/**
 * Size for deferred retransmit job during WiFi OOS
 */
#define OOS_RETRANSMIT_JOB_QUEUE_SIZE 10
...
typedef enum {
	REDIRECT_NONE = 0,
	REDIRECT_IKE_SA_ESTABLISHING_START,
	REDIRECT_IKE_SA_ESTABLISHED_START,
	REDIRECT_CHILD_SA_ESTABLISHED_START,
	REDIRECT_SUCCESS
}redirect_state_t;
/**
 * State of an IKE_SA.
...
struct ike_sa_t {
	...
	status_t (*send_force_dpd) (ike_sa_t *this, u_int32_t retran_to,
								u_int16_t retran_tries, u_int16_t retran_base);
	u_int32_t (*get_force_dpd_retran_to) (ike_sa_t *this);
	u_int16_t (*get_force_dpd_retran_tries) (ike_sa_t *this);
	u_int16_t (*get_force_dpd_retran_base) (ike_sa_t *this);
	...
	bool (*get_wdrv_keepalive) (ike_sa_t *this);
	...
	void (*notify_wod_dpd_interval) (ike_sa_t *this);
	ike_sa_t* (*get_redirect_previous_ike_sa) (ike_sa_t *this);
	void (*set_redirect_previous_ike_sa) (ike_sa_t *this, ike_sa_t* previous_ike_sa);
	int (*get_status_code) (ike_sa_t *this);
	void (*set_status_code) (ike_sa_t *this, int status_code);
	redirect_state_t (*get_redirect_state) (ike_sa_t *this);
	void (*set_redirect_state) (ike_sa_t *this, redirect_state_t status_code);
	int (*get_sub_error_code) (ike_sa_t *this);
	void (*set_sub_error_code) (ike_sa_t *this, int sub_error_code);
	bool (*get_local_address_changed) (ike_sa_t *this);
	void (*set_local_address_changed) (ike_sa_t *this, bool enable);
	...
	*/
	...
	/**
	* set network emergency service support
	*/
	void (*set_nw_emergency_support) (ike_sa_t *this, bool flag);

	/**
	* get network emergency service support status
	*/
	bool (*get_nw_emergency_support) (ike_sa_t *this);
	...
	*/
	...
	/**
	 * Defer the retransmit job into IKE SA's queue during OOS.
	 * The deferred job will be resume after recover from OOS.
	 *
	 * @param job			Retransmit job to be deferred
	 */
	void (*defer_retransmit_job) (ike_sa_t *this, job_t *job);
