	...
	private_ike_rekey_t *this, message_t *message)
{
	...
	if (this->new_sa == NULL)
	{
		...
		/* Inherit "wdrv_keepalive" value from old IKE SA */
		this->new_sa->set_wdrv_keepalive(this->new_sa, this->ike_sa->get_wdrv_keepalive(this->ike_sa));

		/* inherit redirect previous ike sa within ike rekey */
		this->new_sa->set_redirect_previous_ike_sa(this->new_sa, this->ike_sa->get_redirect_previous_ike_sa(this->ike_sa));
		this->new_sa->set_redirect_state(this->new_sa, this->ike_sa->get_redirect_state(this->ike_sa));
