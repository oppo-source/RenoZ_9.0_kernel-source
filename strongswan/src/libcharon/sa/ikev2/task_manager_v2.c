...
#include <sa/ikev2/tasks/ike_nbifom_generic_container.h>
					...
					switch (payload->get_type(payload))
					{
						case NOTIFY:
						{
							...
							switch (notify->get_notify_type(notify))
							{
								...
								{
									DBG1(DBG_CFG, "NBIFOM generic container informational message handling task");
									task = (task_t*)ike_nbifom_generic_container_create(
																this->ike_sa, FALSE);
									break;
								}
								case REDIRECT:
