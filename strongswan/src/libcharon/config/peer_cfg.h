...
struct peer_cfg_t {
	...
	*/
	...
	/**
	 * enable redirect feature
	 */
	void (*enable_redirect_feature)(peer_cfg_t *this);

	/**
	*  get whether enable redirect feature
	*@return        TRUE to enable redirect feature
	*/
	bool (*get_redirect_enable) (peer_cfg_t *this);

	/**
	 * set  max redirect times
	 *
	 */
	void (*set_max_redirects) (peer_cfg_t *this, u_int max_redirects);

	/**
	 * set  redirect loop detect period
	 *
	 */
	void (*set_redirect_loop_detect) (peer_cfg_t *this, u_int redirect_loop_detect);

	/**
	*  get max redirects cfg
	*@return     max redirects number
	*/
	u_int32_t (*get_max_redirects) (peer_cfg_t *this);

	/**
	*  get redirect loop detect period cfg
	*@return     max redirects number
	*/
	u_int32_t (*get_redirect_loop_detect) (peer_cfg_t *this);

	/**
	*  whether  emergency_numbers feature supports
	*@return        TRUE to enable emergency_numbers feature
	*/
	bool (*get_emergency_numbers) (peer_cfg_t *this);
	...
	*/
	...
	void (*set_wod_options)(peer_cfg_t *this, char *imei, char *vif,
							...
							u_int redirect_loop_detect, bool emergency_numbers,
							u_int16_t imei_format);
	char* (*get_imei)(peer_cfg_t *this);
	char* (*get_imei_bcd_encoded)(peer_cfg_t *this);
	u_int16_t (*get_imei_bcd_encoded_size)(peer_cfg_t *this);
	...
	u_int16_t (*get_imei_format)(peer_cfg_t *this);
