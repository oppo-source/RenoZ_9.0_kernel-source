	...
	u_int16_t imei_format)
{
	...
	this->emergency_numbers = emergency_numbers;
...
METHOD(peer_cfg_t, get_emergency_numbers, bool,
	private_peer_cfg_t *this)
{
							...
							identification_t *peer_id)
{
	...
	INIT(this,
		.public = {
			...
			.get_emergency_numbers = _get_emergency_numbers,
			.get_imei = _get_imei,
